...
public:
  ...
  inline unsigned nRC() const { return (k_nRC); }
  inline unsigned nRRD() const { return (k_nRRD); }
  inline unsigned nRRD_L() const { return (k_nRRD_L); }
  inline unsigned nRRD_S() const { return (k_nRRD_S); }
  inline unsigned nRCD() const { return (k_nRCD); }
  inline unsigned nCCD() const { return (k_nCCD); }
  inline unsigned nCCD_L() const { return (k_nCCD_L); }
  inline unsigned nCCD_L_WR() const { return (k_nCCD_L_WR); }
  inline unsigned nCCD_S() const { return (k_nCCD_S); }
  inline unsigned nAL() const { return (k_nAL); }
  inline unsigned nCL() const { return (k_nCL); }
  inline unsigned nCWL() const { return (k_nCWL); }
  inline unsigned nWR() const { return (k_nWR); }
  inline unsigned nWTR() const { return (k_nWTR); }
  inline unsigned nWTR_L() const { return (k_nWTR_L); }
  inline unsigned nWTR_S() const { return (k_nWTR_S); }
  inline unsigned nRTW() const { return (k_nRTW); }
  inline unsigned nEWTR() const { return (k_nEWTR); }
  inline unsigned nERTW() const { return (k_nERTW); }
  inline unsigned nEWTW() const { return (k_nEWTW); }
  inline unsigned nERTR() const { return (k_nERTR); }
  inline unsigned nRAS() const { return (k_nRAS); }
  inline unsigned nRTP() const { return (k_nRTP); }
  inline unsigned nRP() const { return (k_nRP); }
  inline unsigned nRFC() const { return (k_nRFC); }
  inline unsigned nREFI() const { return (k_nREFI); }
  inline unsigned nFAW() const { return (k_nFAW); }
  inline unsigned nBL() const { return (k_nBL); }
