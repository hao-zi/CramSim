  ...
  if (0 < m_timer) {
    ...
    if (m_receivedCommandPtr) {
        ...
        case e_BankCommandType::READ:
          if ((l_time) >
              (x_bank->getLastCommandCycle(e_BankCommandType::WRITE) +
               m_bankParams->at("nWR") + m_bankParams->at("nWTR"))) {
            if ((l_time -
                 (x_bank->getLastCommandCycle(e_BankCommandType::WRITE) +
                  m_bankParams->at("nWR") + m_bankParams->at("nWTR"))) <
                (m_bankParams->at("nWR") + m_bankParams->at("nWTR"))) {
            ...
            m_timerExit = m_bankParams->at("nWR") + m_bankParams->at("nWTR");
          }
          break;
        case e_BankCommandType::PRE:
          if ((l_time) >
            ...
            if ((l_time -
                 (x_bank->getLastCommandCycle(e_BankCommandType::WRITE) +
                  m_bankParams->at("nWR"))) < m_bankParams->at("nWR")) {
              m_timerExit =
                  m_bankParams->at("nWR") -
                  (l_time -
                   (x_bank->getLastCommandCycle(e_BankCommandType::WRITE) +
      ...
      if (1 < m_timerExit) {
        ...
        if ((nullptr != m_nextStatePtr) && (m_receivedCommandPtr != nullptr))
...
void c_BankStateWrite::enter(c_BankInfo *x_bank, c_BankState *x_prevState,
  ...
  if (nullptr != m_prevCommandPtr) {
    ...
    case e_BankCommandType::WRITE:
      m_timer = std::max(m_bankParams->at("nCCD_L"), m_bankParams->at("nBL"));
      break;
    case e_BankCommandType::READ:
  ...
  x_bank->setNextCommandCycle(
      ...
      (std::max(
          ...
          std::max(
              ...
              std::max(x_bank->getLastCommandCycle(e_BankCommandType::WRITEA) +
                           m_bankParams->at("nCWL") + m_bankParams->at("nBL") +
                           m_bankParams->at("nWR"),
                       x_bank->getLastCommandCycle(e_BankCommandType::WRITE) +
                           m_bankParams->at("nCWL") + m_bankParams->at("nBL") +
