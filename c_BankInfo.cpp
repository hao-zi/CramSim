...
c_BankInfo::c_BankInfo() : m_bankState(new c_BankStateIdle(nullptr)) {
...
c_BankInfo::c_BankInfo(std::map<std::string, unsigned> *x_bankParams,
                       unsigned x_bankId)
    : m_bankParams(x_bankParams), m_bankId(x_bankId),
      m_bankState(new c_BankStateIdle(x_bankParams)), m_autoPrechargeTimer(0) {
...
void c_BankInfo::reset() {
  m_lastCommandCycleMap = {
      {e_BankCommandType::ACT, 0},    {e_BankCommandType::READ, 0},
      {e_BankCommandType::READA, 0},  {e_BankCommandType::WRITE, 0},
      {e_BankCommandType::WRITEA, 0}, {e_BankCommandType::PRE, 0},
      {e_BankCommandType::REF, 0}};

  m_nextCommandCycleMap = {
      {e_BankCommandType::ACT, 0},    {e_BankCommandType::READ, 0},
      {e_BankCommandType::READA, 0},  {e_BankCommandType::WRITE, 0},
      {e_BankCommandType::WRITEA, 0}, {e_BankCommandType::PRE, 0},
      {e_BankCommandType::REF, 0}};
...
void c_BankInfo::handleCommand(c_BankCommand *x_bankCommandPtr,
  ...
  assert(m_nextCommandCycleMap.end() !=
         m_nextCommandCycleMap.find(x_bankCommandPtr->getCommandMnemonic()));
  assert(x_simCycle >=
         m_nextCommandCycleMap[x_bankCommandPtr->getCommandMnemonic()]);
