...
unsigned c_Channel::getNumRanks() const { return m_rankPtrs.size(); }

unsigned c_Channel::getChannelId() const { return m_chId; }
        ...
        l_nextCycle = std::max(
            ...
            l_time + m_bankParams->at("nCL") +
                std::max(m_bankParams->at("nBL"),
                         std::min(m_bankParams->at("nCCD_S"),
                                  m_bankParams->at("nCCD_L"))) +
                m_bankParams->at("nERTW") - m_bankParams->at("nCWL"));
        ...
        SimTime_t l_nextCycle = std::max(
            ...
            l_time + m_bankParams->at("nCWL") +
                std::max(m_bankParams->at("nBL"),
                         std::min(m_bankParams->at("nCCD_S"),
                                  m_bankParams->at("nCCD_L"))) +
                m_bankParams->at("nEWTR") - m_bankParams->at("nCL"));
